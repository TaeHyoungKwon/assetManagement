...
@pytest.mark.asyncio
@patch('api.v1.authentication.service.kakao_service.oauth.kakao.authorize_access_token')
...
async def test_authenticate_with_kakao_success(mock_get, mock_authorize_access_token):
    ...
    mock_get.assert_called_once_with("https://kapi.kakao.com/v2/user/me", headers={"Authorization": "Bearer test_access_token"})
